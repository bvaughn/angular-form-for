...
function buildNav(members) {
    ...
    if (members.modules.length) {
        nav += '<li class="list-group-item"><h3>Modules</h3><ul>';
    ...
    if (members.externals.length) {
        nav += '<li class="list-group-item"><h3>Externals</h3><ul>';
        ...
        for (var groupName in groups) {
            ...
            groups[groupName].forEach(function(c) {
                if ( !hasOwnProp.call(seen, c.longname) ) {
                    //console.log('class', c);
                    classNav += '<a class="list-group-item" href="' + c.longname + '.html">' + c.name + '</a>';
                }
                seen[c.longname] = true;
            });

            if (classNav !== '') {
                nav += '<li><h3>' + groupName + '</h3><ul class="list-unstyled">';
                nav += classNav;
                nav += '</ul></li>';
            }
        } // for
    ...
    if (members.events.length) {
        nav += '<li class="list-group-item"><h3>Events</h3><ul>';
    ...
    if (members.namespaces.length) {
        nav += '<li class="list-group-item"><h3>Namespaces</h3><ul>';
    ...
    if (members.mixins.length) {
        nav += '<li class="list-group-item"><h3>Mixins</h3><ul>';
    ...
    if (members.tutorials.length) {
        nav += '<li class="list-group-item"><h3>Tutorials</h3><ul>';

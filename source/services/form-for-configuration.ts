 ...
 */
class FormForConfiguration {

  private autoGenerateLabels_:boolean = false;
  private defaultDebounceDuration_:number = 500;
  private defaultSubmitComplete_:(formData:any) => void = function() {};
  private defaultSubmitError_:(error:any) => void = function() {};
  private defaultValidationFailed_:(error:any) => void = function() {};
